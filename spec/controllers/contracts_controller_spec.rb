  ...
  describe "POST #create", :focus => true do
    context "with valid params" do
      it "creates one new Contract." do
        expect {
          post :create, {:contract => valid_attributes, :sealed_flag => true}, valid_session
    ...
    context "with invalid params" do
      it "fails to create new Contract." do
        expect {
          post :create, {:contract => invalid_attributes, :sealed_flag => true}, valid_session
      ...
      it "re-renders the 'new' template" do
        @leaf = Leaf.find(1)
        post :create, {:contract => invalid_attributes}, valid_session
        #expect(response).to render_template(@leaf)
        expect(response).to redirect_to(@leaf)
      end
    end
  end

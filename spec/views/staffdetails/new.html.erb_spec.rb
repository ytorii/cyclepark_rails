...
RSpec.describe "staffdetails/new", type: :view do
  before(:each) do
    assign(:staffdetail, Staffdetail.new(
      :staff => nil,
      :name => "MyString",
      :read => "MyString",
      :address => "MyString",
  ...
  it "renders new staffdetail form" do
    render

    assert_select "form[action=?][method=?]", staffdetails_path, "post" do
